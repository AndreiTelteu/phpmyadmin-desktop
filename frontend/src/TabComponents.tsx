...
const componentsList: App.ComponentItem[] = [
  { 
    id: 'app', name: 'Desktop App', description: 'The desktop app', version: appVersion,
  ...
  {
    id: 'frankenphp', name: 'FrankenPHP Runtime', description: 'PHP server runtime (includes PHP)',
